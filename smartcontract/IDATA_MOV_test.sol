...
interface IDATA_MOV{
    ...
    function addTransaction(uint256 value,string calldata _Description,address destination,uint8 degree,address call_address,bytes calldata call_data,string calldata uri)external returns(uint256 id);
    ...
    function Initiate_a_request(address organ_address,uint256 value,string calldata _Description,uint8 degree,address call_address,bytes calldata call_data,string calldata uri)external  returns(bool);
   ...
   function get_transaction3(uint id)external view returns (
   ...
   function get_request(uint id)external view returns(
       address to,
        ...
        uint256 done_time,
        bool executed);
  function get_request2(uint id)external  view returns (
        address call_address,bytes memory call_data,string memory uri
       );
